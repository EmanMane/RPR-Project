...
class HabitatManagerTest {
    ...
    void validateHabitatName() throws AnimalException {
        ...
        AnimalException quoteException1 = Assertions.assertThrows(AnimalException.class, () -> {
            habitatManager.validateHabitatName(incorrectNameShort);}, "Habitat name must be between 3 and 45 chars");
        Assertions.assertEquals("Habitat name must be between 3 and 45 chars", quoteException1.getMessage());
        ...
        AnimalException quoteException2 = Assertions.assertThrows(AnimalException.class, () -> {
            habitatManager.validateHabitatName(incorrectNameLong);}, "Habitat name must be between 3 and 45 chars");
        Assertions.assertEquals("Habitat name must be between 3 and 45 chars", quoteException2.getMessage());
    }
    ...
    void add() throws AnimalException {
        ...
        AnimalException quoteException = Assertions.assertThrows(AnimalException.class, () -> {
            habitatManager.add(habitat);}, "Can't add habitat with ID. ID is autogenerated");

        Assertions.assertEquals("Can't add habitat with ID. ID is autogenerated", quoteException.getMessage());
